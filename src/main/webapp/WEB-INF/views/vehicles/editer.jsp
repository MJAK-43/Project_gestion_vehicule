...
<%--                                     <label for="first_name" class="col-sm-2 control-label">${ idUser}</label> --%>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" id="id" name="id" value="${idvehicle}">  <!-- permet de recuperer l'id du client -->
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" value="${numPlace}" required>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
